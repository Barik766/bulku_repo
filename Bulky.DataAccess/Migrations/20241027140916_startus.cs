...
{
    /// <inheritdoc />
    public partial class startus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Category___Id = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.Category___Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryReferenceId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Categories_CategoryReferenceId",
                        column: x => x.CategoryReferenceId,
                        principalTable: "Categories",
                        principalColumn: "Category___Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Category___Id", "DisplayOrder", "Name" },
                values: new object[,]
                {
                    { 1, 1, "Action" },
                    { 2, 2, "Sci-Fi" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Redmond", "Microsoft", "425 882 0000", "98052", "WA", "1 Microsoft Way" },
                    { 2, "Cupertino", "Apple", "408 996 1000", "95014", "CA", "1 Infinite Loop" },
                    { 3, "Mountain View", "Google", "650 253 0000", "94043", "CA", "1600 Amphitheatre Parkway" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Author", "CategoryReferenceId", "Description", "ISBN", "ImageUrl", "ListPrice", "Price", "Price100", "Price50", "Title" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CategoryReferenceId",
                table: "Products",
                column: "CategoryReferenceId");
